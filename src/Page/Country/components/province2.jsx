 ...
 * 
 */
class Province2 extends React.Component{
    constructor(props)
    {
        super(props) ;
        this.option = {
    ...
    async componentDidMount()
    {
        ...
        this.chartDom = document.getElementById('Province2');
    ...
    getData()
    {
        axios.get('/api1/g2/getOnsInfo?name=disease_h5').then(res=>{
            ...
            let newArray = children[2].children
    ...
    render()
    {
        return(
            <div style={{width:"100%"}}>
                ...
                <div id="Province2" style={{width:"100%",height:'15rem'}}></div>
            </div>
        )
    }
}
